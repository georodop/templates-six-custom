...
<footer id="main-footer">
	<div class="container">
		<div id="footer-widgets" class="clearfix et_pb_row">
			<div class="et_pb_column et_pb_column_1_3 footer-widget">
				<div id="text-2" class="fwidget et_pb_widget widget_text"><h4 class="title">Η iBS στην Ελλάδα</h4>			
					<div class="textwidget">
						...
						<p><a class="linkscolor" href="http://www.ibs.gr/epikinonia/"> Επικοινωνήστε μαζί μας</a></p>
					</div>
				</div> <!-- end .fwidget -->
			...
			<div class="et_pb_column et_pb_column_1_3 footer-widget">		
				...
				<div id="text-6" class="fwidget et_pb_widget widget_text">			
					<div class="textwidget"><a class="linkscolor" href="http://www.ibs.gr/blog/">Διαβάστε ολα τα νέα της iBS στο BLOG μας</a></div>
				</div> <!-- end .fwidget -->
			</div> <!-- end .footer-widget -->
			<div class="et_pb_column et_pb_column_1_3 footer-widget">
				<div id="text-4" class="fwidget et_pb_widget widget_text">
					<h4 class="title">Θέλετε Τεχνική Υποστήριξη;</h4>			
					<div class="textwidget">
						<p>Χρειάζεστε έναν επαγγελματία για να παρέχει τεχνική υποστήριξη για το δίκτυο της εταιρίας σας ή τον δημοσιευμένο ιστότοπό σας;</p>
						<p><a class="linkscolor" href="/submitticket.php">Αίτημα Τεχνικής Υποστήριξης</a></p>
					</div>
				</div> <!-- end .fwidget -->
			</div> <!-- end .footer-widget -->	
		</div> <!-- #footer-widgets -->
	...
	<div id="et-footer-nav">
		<div class="container">
			<ul id="menu-menou-iposelidou" class="bottom-nav">
				<li id="menu-item-3715" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3715"><a href="http://www.ibs.gr/ori-chrisis-istotopou-ibs-gr/">Όροι Χρήσης ιστοτόπου ibs.gr</a></li>
